...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanel" runat="Server">
    <div id="ContentPanel" class="ContentPanel">
        ...
        <h2>
            La scuola</h2>
        <h3>
            La scuola sarà operativa a partire da Giugno 2012</h3>
        <p>
        ...
        <p>
            Per iscrizioni, <a href="mailto:info@mtbscout.it">scrivici una mail</a> o contatta
            il 338.3681001.</p>
        <h2>
        ...
        <h4>
            <a target="schoolmap" href="http://maps.google.it/maps/myplaces?hl=it&ll=44.52607,9.06754&spn=0.001595,0.003613&ctz=-120&t=m&layer=c&cbll=44.526057,9.067671&panoid=_4c7DHvgZ28K-rtTqtjRUA&cbp=12,207.57,,0,24.89&z=19"
                style="color: #0000FF; text-align: left">Visualizza campo scuola in Google Street
                View</a></h4>
