...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanel" runat="Server">
    <div id="ContentPanel" class="ContentPanel">
        ...
        <p>
            ...
            qui, su carrareccia, si scende sulla strada asfaltata che porta a Donetta, in corrispondenza del centro abitato di Porcarezze.
        </p>
        <p>
            Si prosegue su asfalto fino a Donetta quindi, oltrepassato il centro abitato e giunti all&#39;incrocio con la SP15, si imbocca
            i sentiero di cresta che conduce sopra la galleria di Buffalora prima (divertente
            discesa) e alle pendici del monte Lavagnola poi; è questo un impegnativo sentiero
            in salita, in particolare nel tratto terminale, ma interamente pedalabile se si
            escludono alcuni piccoli tratti in caso di fondo bagnato.</p>
        <p>
            ...
            scaldare animo e freni, giungendo così sulla strada asfaltata nei pressi di Obbi. Si attraversa
            la strada e si imbocca quasi subito il sentiero che scende nel rio sottostante Torriglia,
            per poi risalire in quota fino all&#39;arrivo.</p>
        <p>
            ...
            <h2>Costo iscrizione: 12 euro - Casco obbligatorio - Non occorre essere tesserati</h2>
        <iframe src="map.html" style="width:800px;height:400px;"></iframe>
        <p class="centered"><a title="Scarica tracciato GPS" href="torriglia.zip">Scarica tracciato GPS</a></p>
