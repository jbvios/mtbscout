...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanel" runat="Server">
	<div id="ContentPanel" class="ContentPanel">
		<asp:GridView ID="GridViewSubscriptions" runat="server" AutoGenerateDeleteButton="True"
			AutoGenerateEditButton="True" Caption="Elenco dei partecipanti che hai registrato" 
